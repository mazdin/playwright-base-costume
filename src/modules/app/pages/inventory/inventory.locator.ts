...
export default class InventoryLocator extends BaseLocator {
    ...
    static itemPrice: string = '.inventory_item_price';
    static itemImage: string = '.inventory_item_img img';
    static sortDropdown: string = '.product_sort_container';
    static cartBadge: string = '.shopping_cart_badge';
    static cartIcon: string = '.shopping_cart_link';
    static addToCartBackpack: string = '[data-test="add-to-cart-sauce-labs-backpack"]';
